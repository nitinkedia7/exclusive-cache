...
HD_PWD='/home/nk7/Lab6_BRAM2/Lab6_BRAM2.runs/L2_block_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log L2_block_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source L2_block_blk_mem_gen_0_0.tcl
